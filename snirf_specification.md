...
Note that the numeric value in this array is the exponent in the integral used for calculating the moments. For detailed/specific definitions of moments, see `Wabnitz et al, 2020 <https://doi.org/10.1364/BOE.396585>`_ (for general definitions of moments see `here <https://en.wikipedia.org/wiki/Moment_(mathematics)>`_).
