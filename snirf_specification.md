...
Note that the numeric value in this array is the exponent in the integral used for calculating the moments. For a full description of the moment definitions, see Wabnitz et al, 2020 or Liebert et al, 2003. In Brief, given a DTOF (N(t): photon counts vs. photon arrival time at the detector):
